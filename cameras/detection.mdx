...
- **Hikvision**: 3 users × 6 paths = 18 combinations per password
- **Unknown device**: 1 user × 19 paths = 19 combinations per password
- **Without detection**: Would need to test all possible combinations
